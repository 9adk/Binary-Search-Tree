...
class BinarySearchTreeTest {
	...
	/**
	 * Searching particular node in the tree
	 */
	@Test
	void givenNode_WhenSearchedInTree_ShouldReturnTrue() {
		MyBinarySearchTree<Integer> bst = new MyBinarySearchTree<>();
		bst.add(56);
		bst.add(30);
		bst.add(70);
		...
		bst.add(63);
		bst.add(67);
		assertTrue(bst.searchKey(63));
	}

	/**
	 * Checking whether the node exist or not
	 */
	@Test
	void givenNode_WhenSearchedInTree_ShouldReturnFalse() {
		MyBinarySearchTree<Integer> bst = new MyBinarySearchTree<>();
		bst.add(56);
		bst.add(30);
		bst.add(70);
